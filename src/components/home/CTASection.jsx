      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        >
          <h2 className="text-4xl font-bold tracking-tight">
            Ready to Turn Art into Memories?
          </h2>
          <p className="text-lg text-muted-foreground mt-6 mb-8">
            Create a one-of-a-kind storybook that captures your child's imagination and creativity.
            Each book is professionally printed and bound to last for generations.
          </p>
          
          <Link
            to="/product"
            className="inline-flex h-12 items-center justify-center rounded-md bg-primary px-8 text-base font-medium text-primary-foreground shadow-lg transition-all hover:bg-primary/90 hover:shadow-primary/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
